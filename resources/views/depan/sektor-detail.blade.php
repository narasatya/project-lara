...
<body>
                        ...
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="#sektor-detail"
                                    class="flex py-2 mx-8 text-base text-dark group-hover:text-primary">Sektor Usaha</a>
                            </li>
                            <li class="group">
                                <a href="#hub"
    ...
    <!-- HERO SECTION MULAI -->
    {{-- pt-60 if desktop --}}
    <section id="home" class="bg-violet-300 mt-36 dark:bg-dark">
    ...
    <!-- BODY SECTION MULAI -->
    <section id="sektor-detail" class="pb-32 pt-36 dark:bg-dark">
        <div class="container">
            <div class="overflow-auto rounded-lg shadow">
                <table class="table w-full table-striped">
                    <thead class="justify-center border-b-2 border-gray-200 bg-primary">
                        <tr>
                            <th class="p-3 text-base font-semibold tracking-wide text-left text-white">Nama Perusahaan
                            </th>
                            <th class="p-3 text-base font-semibold tracking-wide text-left text-white">Produk Usaha
                                Utama</th>
                            <th class="p-3 text-base font-semibold tracking-wide text-left text-white">Jumlah Tenaga
                                Kerja</th>
                            <th class="p-3 text-base font-semibold tracking-wide text-left text-white">Provinsi</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-300">
                        @foreach ($detail as $usaha)
                            <tr class="bg-gray-100 dark:bg-slate-700">
                                <td class="p-3 text-base text-primary whitespace-nowrap">
                                    <a href="{{ url('/umkmDetail/' . $usaha->id) }}" data-toggle="modal"
                                        data-target="#yourModal" class="hover:underline">
                                        {{ $usaha->nama_usaha }}
                                    </a>
                                </td>
                                <td class="p-3 text-base text-primary whitespace-nowrap">
